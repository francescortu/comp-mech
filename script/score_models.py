...
for orthogonalize in [True, False]:
    for premise in ["Redefine", "Assume", "Suppose", "Context"]:
        for model_name in models_name:
            ...
            dataset = HFDataset(dataset_path, tokenizer=tokenizer, premise=premise, slice=10000)

            evaluator = EvaluateMechanism(
                model_name, dataset, device=DEVICE, batch_size=50, orthogonalize=orthogonalize, premise=premise, family_name=f"gpt2")
